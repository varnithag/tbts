...
public class ITBTS_Scheduler {
	...
	public static void run() {
		Log.printLine("Starting ITBTS algorithm...");
		...
		try {
			...
			ITBTSDatacenterBroker broker = createBroker("Broker_0");
            int brokerId = broker.getId();

			//Fourth step: Create VMs and Cloudlets and send them to broker
			vmlist = createVM(brokerId,vmandTaskCount.vmscount); //creating 20 vms
			cloudletList = createCloudlet(brokerId,vmandTaskCount.taskscount); // creating 40 cloudlets
			...
			Log.printLine("ITBTS algorithm finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	private static void datacentercreation() {
		...
		Datacenter datacenter17 = createDatacenter("Datacenter_17");
		Datacenter datacenter18 = createDatacenter("Datacenter_18");
		Datacenter datacenter19 = createDatacenter("Datacenter_19");
	...
	private static ITBTSDatacenterBroker createBroker(String name) throws Exception {
        return new  ITBTSDatacenterBroker(name);
    }
